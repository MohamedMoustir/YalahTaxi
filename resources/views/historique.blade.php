  ...
  <header class="bg-yellow-500 shadow-md">
    <div class="container mx-auto px-4 py-3 flex justify-between items-center">
      <div class="flex items-center">
        <h1 class="text-2xl font-bold text-white">YalahTaxi</h1>
      </div>
      <div class="flex items-center space-x-4">
        <button class="bg-white text-yellow-700 px-4 py-2 rounded-full font-medium text-sm hover:bg-gray-100 transition-colors duration-200">
          Voir comme chauffeur
        </button>
        <div class="relative">
          <img src="/api/placeholder/40/40" alt="Avatar" class="w-10 h-10 rounded-full border-2 border-white">
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="container mx-auto px-4">
      <div class="flex flex-col md:flex-row justify-between items-center">
        <div class="mb-4 md:mb-0">
          <h2 class="text-xl font-bold">YalahTaxi</h2>
          <p class="text-gray-400 text-sm mt-1">Votre service de taxi de confiance</p>
        </div>
        <div class="flex space-x-4">
          <a href="#" class="text-gray-400 hover:text-white transition-colors duration-200">Aide</a>
      ...
      <div class="mt-6 border-t border-gray-700 pt-6 text-center text-sm text-gray-400">
        &copy; 2025 YalahTaxi. Tous droits réservés.
      </div>
    </div>
  </footer>
</body>
