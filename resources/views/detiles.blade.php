...
<body class="bg-gray-50">
    ...
    <nav class="bg-gray-800 py-4">
        <div class="container mx-auto px-4 flex justify-between items-center">
            <div class="text-amber-400 font-bold text-2xl">YalahTaxi</div>
            <div class="hidden md:flex space-x-6">
                <a href="#connexion" class="text-white hover:text-amber-400">Connexion</a>
                <a href="#inscription" class="text-white hover:text-amber-400">Inscription</a>
                <a href="{{ route('historique',['id'=>Auth::id()])}}" class="text-white hover:text-amber-400">historique</a>
            </div>
        </div>
    </nav>
            ...
            <div class="md:col-span-2 bg-white p-6 rounded-lg shadow-lg">
                ...
                <div class="grid grid-cols-3 gap-4 mb-6">
                    ...
                    <div class="bg-gray-50 p-4 text-center rounded">
                        ...
                        <div class="font-bold">6 passagers</div>
                    </div>
                </div>
        ...
        <div class="grid md:grid-cols-2 gap-6 mb-6">
            <div>
                ...
                <input name="departure_time" type="datetime-local" 
                       class="w-full p-2 border rounded focus:ring-2 focus:ring-amber-400">
            </div>
            <div>
