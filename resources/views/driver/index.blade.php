            ...
            <header class="header">
                ...
                <div class="profile">
                    <form action="{{ Route('disponible') }}" method="post">
                        @csrf
                        @if ($driver->driveer->is_available == false)
                        <input type="hidden" name="oui" value="false">
                        <button class="bg-red-500 text-white py-2 px-4 rounded  cursor">
                        Non disponible
                        </button>

                        @else
                        <input type="hidden" name="Non" value="true">
                             <button class="availability-toggle">disponible</button>
                        @endif
